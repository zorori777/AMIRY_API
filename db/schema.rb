...
ActiveRecord::Schema.define(version: 20171229115409) do
  ...
  create_table "article_files", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id", null: false, unsigned: true
    t.integer "target_model_type", limit: 1, default: 0, null: false, unsigned: true
    t.integer "target_model_id", default: 0, null: false, unsigned: true
    t.string "body", default: "", null: false
